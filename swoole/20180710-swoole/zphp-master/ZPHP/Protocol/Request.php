...
class Request
{
    ...
    private static $_params;//请求参数
    private static $_ctrl = 'main';//控制器
    private static $_method = 'main'; //方法
    private static $_view_mode = null;//视图展示模式
    private static $_tpl_file = '';//模板文件
    private static $_fd = null; // 描述符
    private static $_long_server = 0;//是否为常量
    private static $_is_http = 1;//是否是 http 服务器
    private static $_request = null;// swoole http server 的 request 对象
    private static $_socket = null;  //swoole server 对象
